...
WebUI.callTestCase(findTestCase('TC UDEMY/Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_hjhjMiri Katz'))
